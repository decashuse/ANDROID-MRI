...
ObjPtr<mirror::Class> ClassLinker::FindClassInBootClassLoaderClassPath(Thread* self,
	...
	// decash
	//if( is_target_uid() )
    //			DECASH_ART( "FindClassInBootClassLoaderClassPath : " + std::string(descriptor) );
	//
...
ObjPtr<mirror::Class> ClassLinker::FindClassInBaseDexClassLoaderClassPath(
  ...
  DCHECK(IsPathOrDexClassLoader(soa, class_loader) ||
	...
	// decash
	//if( is_target_uid() )
    //			DECASH_ART( "FindClassInBaseDexClassLoaderClassPath : " + std::string(descriptor) );
	//
...
ObjPtr<mirror::Class> ClassLinker::FindClass(Thread* self,
  ...
  DCHECK(self != nullptr);
	...
	//decash
	//if( is_target_uid() )
	//		DECASH_ART( "FindClass : " + std::string(descriptor) );
	////////
  self->AssertNoPendingException();
...
ObjPtr<mirror::Class> ClassLinker::DefineClass(Thread* self,
  ...
  auto klass = hs.NewHandle<mirror::Class>(nullptr);
	...
	//decash
	//if( is_target_uid() )
	//		DECASH_ART( "DefineClass : " + std::string(descriptor) );
	///////
...
static void LinkCode(ClassLinker* class_linker,
  ...
  if (quick_code == nullptr) 
	{
    method->SetEntryPointFromQuickCompiledCode(method->IsNative() ? GetQuickGenericJniStub() : GetQuickToInterpreterBridge());
  } 
  ...
  if (method->IsNative()) {
    ...
    method->SetEntryPointFromJni(method->IsCriticalNative() ? GetJniDlsymLookupCriticalStub() : GetJniDlsymLookupStub());
