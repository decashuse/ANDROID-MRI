...
private rule jack_4_12 : compiler
{
  meta:
...
private rule jack_generic : compiler
{
...
private rule dexlib2beta : compiler
{
  meta:
...
private rule dx_merged : compiler
{
  meta:
...
private rule r8_merged : compiler
{
  meta:
...
private rule r8_no_marker : compiler
{
  meta:
...
rule dexmerge : anti_disassembly
{
  meta:
...
private rule unknown_compiler : compiler {
  meta:
