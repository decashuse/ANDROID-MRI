...
class Thread {
 public:
  ...
  //decash//////////////////////////
  void DecashDump(std::ostream& os,
  				  bool dump_native_stack = true,
        		  BacktraceMap* backtrace_map = nullptr,
				  bool force_dump_stack = false) const
 ...
 public:
  ...
  void AssertHasDeoptimizationContext()
      REQUIRES_SHARED(Locks::mutator_lock_);
	//decash original not include mutator_lock 
  //void PushStackedShadowFrame(ShadowFrame* sf, StackedShadowFrameType type);
  void PushStackedShadowFrame(ShadowFrame* sf, StackedShadowFrameType type)REQUIRES_SHARED(Locks::mutator_lock_);
 ...
 private:
  ...
  //decash
  void DecashDumpStack(std::ostream& os,
                bool dump_native_stack = true,
                BacktraceMap* backtrace_map = nullptr,
                bool force_dump_stack = false) const
     REQUIRES(!Locks::thread_suspend_count_lock_)
