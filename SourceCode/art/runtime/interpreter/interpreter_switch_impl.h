...
template<bool do_access_check, bool transaction_active>
ALWAYS_INLINE JValue ExecuteDecashSwitchImpl(Thread* self, const CodeItemDataAccessor& accessor,
                                       ShadowFrame& shadow_frame, JValue result_register,
                                       bool interpret_one_instruction)
  REQUIRES_SHARED(Locks::mutator_lock_) {
  SwitchImplContext ctx {
	...
	//decash
  void* impl = reinterpret_cast<void*>(&ExecuteDecashSwitchImplCpp<do_access_check, transaction_active>);
...
template<bool do_access_check, bool transaction_active>
ALWAYS_INLINE JValue ExecuteDecashSwitchImpl1(Thread* self, const CodeItemDataAccessor& accessor,
                                       ShadowFrame& shadow_frame, JValue result_register,
                                       bool interpret_one_instruction)
  REQUIRES_SHARED(Locks::mutator_lock_) {
  SwitchImplContext ctx {
	...
	//decash
  void* impl = reinterpret_cast<void*>(&ExecuteDecashSwitchImplCpp1<do_access_check, transaction_active>);
