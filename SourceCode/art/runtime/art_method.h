...
class ArtMethod final {
 public:
  ...
  void Invoke(Thread* self, uint32_t* args, uint32_t args_size, JValue* result, const char* shorty)
      REQUIRES_SHARED(Locks::mutator_lock_);
	//decash///////////
  void OriginalCode(Thread* self, uint32_t* args, uint32_t args_size, JValue* result, const char* shorty)
      REQUIRES_SHARED(Locks::mutator_lock_);
 
 	void DisplayInputArgs(Thread* self, uint32_t* args, uint32_t args_size, const char* shorty) 
      REQUIRES_SHARED(Locks::mutator_lock_);

  void DisplayReturnArgs(JValue* result, const char* shorty) 
      REQUIRES_SHARED(Locks::mutator_lock_);

	void DisplayInputSearchItems(Thread* self, uint32_t* args, uint32_t args_size, const char* shorty) 
      REQUIRES_SHARED(Locks::mutator_lock_);

	void DisplayReturnSearchItems(Thread* self, JValue* result, const char* shorty) 
      REQUIRES_SHARED(Locks::mutator_lock_);
	///////////////////
